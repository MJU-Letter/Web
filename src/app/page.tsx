  ...
  return (
    <div className='w-360 min-h-640 flex flex-col items-center justify-center'>
      ...
      <h2 className='w-284 mt-8 flex text-11 text-gray-medium-text-2 flex-wrap whitespace-pre-line'>
        시작할 경우, 명지편지의
        <div className='ml-[3.5px] border-b-1 border-gray-medium-text-2 whitespace-pre-line'>서비스 이용약관</div>과
        <div className='ml-[3.5px] border-b-1 border-gray-medium-text-2 whitespace-pre-line'>개인정보 보호정책</div>에
        동의하게 됩니다.
      </h2>
    </div>
  );
