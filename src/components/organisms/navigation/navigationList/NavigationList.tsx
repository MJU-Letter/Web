...
const NavigationList = ({ user, isOpened, setIsOpened }: navigationListProps) => {
  ...
  return (
    <>
      ...
      >
        <div className={`${deviceType === 'mobile' ? 'ml-auto' : ''} flex flex-col w-240 h-screen bg-main-point`}>
          <div className='mb-24 cursor-pointer' onClick={() => setIsOpened(false)}>
